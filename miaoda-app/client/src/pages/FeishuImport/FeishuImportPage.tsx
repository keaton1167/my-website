...
const feishuImportSchema = z.object({
  sourceUrl: z.string().min(1, '飞书文档链接不能为空').url('请输入有效的 URL'),
...
const FeishuImportPage: React.FC = () => {
  ...
  // Reset second category when first category changes
  useEffect(() => {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">飞书文档导入</h1>
        {importStatus && (
              ...
              >
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      toast.success('文档已自动保存为草稿，可在文档管理中查看')
                    }
                  >
...
export default FeishuImportPage;
